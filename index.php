        ...
        <div class="wrapper">
                        ...
                        <ul>
                            ...
                            <li class="dark-bg" data-transition="fade" data-slotamount="5" data-masterspeed="700">
                               ...
                               <!--  <div class="tp-caption lfb ltt tp-resizeme"
                                ...
                                <h2 class="tp-caption lfb ltt tp-resizeme sc-title"
                                    ...
                                    data-endspeed="500"
                                    data-endeasing="Power4.easeIn"
                                    style="z-index: 3; max-width: auto; max-height: auto; white-space: nowrap;">An  All-in-One<br>Digital Signage Solution
                                </h2>
                                ...
                                <div class="tp-caption lfb ltt tp-resizeme sc-button"
                                    ...
                                    data-endeasing="Power4.easeIn"
                                    style="z-index: 3; max-width: auto; max-height: auto; white-space: nowrap;">
                                    <a class="btn btn-md btn-black" href="#about">Learn More</a>
                                </div>
                            ...
                            <li class="dark-bg" data-transition="fade" data-slotamount="5" data-masterspeed="700">
                               ...
                               <!--  <div class="tp-caption lfb ltt tp-resizeme"
                                ...
                                <h2 class="tp-caption lfb ltt tp-resizeme sc-title"
                                    ...
                                    data-endspeed="500"
                                    data-endeasing="Power4.easeIn"
                                    style="z-index: 3; max-width: auto; max-height: auto; white-space: nowrap;">Create and Manage <br> Feature-packed Displays
                                </h2>
                                ...
                                <div class="tp-caption lfb ltt tp-resizeme sc-button"
                                    ...
                                    data-endeasing="Power4.easeIn"
                                    style="z-index: 3; max-width: auto; max-height: auto; white-space: nowrap;">
                                    <a class="btn btn-md btn-black" href="#service">Learn More</a>
                                </div>
                            ...
                            <li class="dark-bg" data-transition="fade" data-slotamount="5" data-masterspeed="700">
                                ...
                                <h2 class="tp-caption lfb ltt tp-resizeme sc-title"
                                    ...
                                    data-endspeed="500"
                                    data-endeasing="Power4.easeIn"
                                    style="z-index: 3; max-width: auto; max-height: auto; white-space: nowrap;">Suitable for <br> All Digital Displays
                                </h2>
            ...
            <section id="about" class="section-padding text-center">
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-5 col-xs-12 content-box mb-sm-30 wow fadeIn" data-wow-delay="0.6s" data-wow-duration="2s">
                            <div class="icon-top"><i class="icon icon-basic-display"></i></div>
                            <h5 class="features-title">Media Player</h5>
                            <p>A reliable playback system that will play 24 hours a day and 365 days a year.</p>
                        </div>
                        <div class="col-md-3 col-sm-5 col-xs-12 content-box mb-sm-30 wow fadeIn" data-wow-delay="0.6s" data-wow-duration="2s">
                            <div class="icon-top"><i class="icon icon-ecommerce-graph2"></i></div>
            ...
            <section id="service" class="section-padding">
                <div class="container mb-60 text-center">
                    ...
                    and saving you time on the small things, you can focus on creating a functional design that 
                    you and your audience will love.</p>
                </div>
                    ...
                    <div class="owl-carousel testimonial-carousel nf-carousel-theme white">
                        <div class="item">
                            <div class="testimonial text-center max-width-700">
                                ...
                                <p class="lead">OunchKiosks were exhibited throughout the TEDxKL event. It was synergistic to have the kiosks as directional guides, to display relevant information and even beautify the event area. Truly important use of space and I am very sure any event would find OunchKiosk a great addition.</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-sm-30 wow fadeIn" data-wow-delay="0.6s" data-wow-duration="2s">
                            ...
                            <p class="contact-link">
                                <a href="mailto:yourname@domain.com"><span class="text-bold">Email :</span> info@omniphics.com</a><br />
                                <a><span class="text-bold">Call :</span> +60388923053</a>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <footer id="footer" class="footer section-padding gray-bg">
                <div class="container text-center">
                    ...
                    <ul class="social">
                        <li>
                            <a href="https://www.facebook.com/omniphics" target="_blank"><i class="fa fa-facebook"></i></a>
                        </li>
                        <li>
                            <a href="https://www.twitter.com/omniphics" target="_blank"><i class="fa fa-twitter"></i></a>
                        </li>
                    </ul>
                    <!-- End Social -->
